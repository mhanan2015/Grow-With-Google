...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        //adding user input to hardcoded URL
        URL githubSearchUrl = NetworkUtils.buildUrl(githubQuery);

        mUrlDisplayTextView.setText(githubSearchUrl.toString());


        //sending the URL to run on inner thread
        new GithubQueryTask().execute(githubSearchUrl);
        // TODO (4) Create a new GithubQueryTask and call its execute method, passing in the url to query
    }

    // TODO (1) Create a class called GithubQuery Task that extends AsyncTask<URL, Void, String>

    //creating class to start Asynctask
    public class GithubQueryTask extends AsyncTask<URL,Void,String>{
        ...
        //overriding the method to display result on main UL
        @Override
