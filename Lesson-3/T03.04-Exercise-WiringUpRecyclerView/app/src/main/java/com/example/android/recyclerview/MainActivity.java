...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int NUM_LIST_ITEMS = 100;  //Set the screen size, app will scroll up to 100 items
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (6) Use setLayoutManager on mNumbersList with the LinearLayoutManager we created above
            mNumbersList.setLayoutManager(layoutManager);// making the layout linear vertically
        ...
        // TODO (8) Store a new GreenAdapter in mAdapter and pass it NUM_LIST_ITEMS
            mAdapter = new GreenAdapter(NUM_LIST_ITEMS); //creating adapter variable with data size
        // TODO (9) Set the GreenAdapter you created on mNumbersList
            mNumbersList.setAdapter(mAdapter);//telling the adaptor show much data will be shown in the app
    }
}
