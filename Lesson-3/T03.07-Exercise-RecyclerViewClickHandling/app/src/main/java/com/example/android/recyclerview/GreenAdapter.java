...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    final private ListItemClickListenerin mOnClickListener;
    ...
    // TODO (1) Add an interface called ListItemClickListenerin
    public interface ListItemClickListenerin{
        void onListItemClick(int clickedItemListner);
     ...
     */
    public GreenAdapter(int numberOfItems, ListItemClickListenerin listener) {
