...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mError_Message = (TextView) findViewById(R.id.tv_error_message);
        // TODO (17) Find the ProgressBar using findViewById
        mPB_loader = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            // TODO (19) As soon as the data is finished loading, hide the loading indicator
             mPB_loader.setVisibility(View.INVISIBLE);
            if (weatherData != null) {
